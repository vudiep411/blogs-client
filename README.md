...
<p><b>Note:</b></p>
<ul>
<li>This is only the front-end of this project. Create your own server and database of your choice (Node.js, Express.js, Django,... ) to integrate a full-stack application</li> <br/>
<li>React-Google-Login is deprecated visit <a href='https://www.npmjs.com/package/@react-oauth/google'>@react-oauth/google</a> for the newer version</li> 
</ul>
<p align="right">(<a href="#readme-top">back to top</a>)</p>
